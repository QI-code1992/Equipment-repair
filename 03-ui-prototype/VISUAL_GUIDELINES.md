...
- Forms show required markers, field-level validation, loading and error states.
- Agent drawer preserves tab history and exposes permission explanations inline.
- Tables support empty, loading, error and pagination states.
- Prototype demo values are not production business values.
