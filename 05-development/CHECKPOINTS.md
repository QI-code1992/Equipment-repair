...
- 状态：Superseded / Changes Requested。该远端恢复点继续保留用于审计和恢复，但 DEV-002 已拒绝其后续候选 `cfb8ed9b99b5e440b3c0bf4a8652f4f7d233ee77`，不得作为 TASK-002 完成、正式 PR 或集成依据。
...
- 取代计划：CR-036 完成真实 PostgreSQL/Compose 验证、DEV-002 交叉审核、正式 PR 和集成后，新增后继 FCP；不得覆盖或删除本条历史。
