  ...
  return <main className="login-page"><div className="login-page__grid" aria-hidden="true" /><div className="login-page__beam" aria-hidden="true" />
    <div className="login-page__content">
      <section className="login-intro" aria-label="平台说明">
        ...
        <p className="login-legacy-context">现场运维 · 受控访问</p>
        <p className="login-legacy-product">新能源装载机智能运维平台</p>
        <h1>设备AI智能运维平台</h1>
      ...
      <form className="login-form" onSubmit={(event) => void submit(event)}>
        <header><h2>登录</h2><h3 className="login-legacy-heading">欢迎回来</h3><p>请输入账号密码进行登录</p></header>
