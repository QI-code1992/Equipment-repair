...
function SystemManagementContent({ canWrite }: { canWrite: boolean }) {
  ...
  return <Page title="系统管理">
    ...
    </>}</State><section className="data-card system-self-account"><header className="panel-heading"><div><h3>我的账号</h3><p>当前账号信息来自认证会话；敏感凭据不会在页面回显。</p></div><span className="status-chip status-chip--neutral">仅本人</span></header><p className="prototype-unavailable">当前页面未提供当前用户详情接口。</p></section></>}
