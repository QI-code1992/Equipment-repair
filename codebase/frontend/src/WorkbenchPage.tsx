  ...
  return <section className="portal-page workbench-page" aria-labelledby="workbench-page-title">
    ...
    <div className="workbench-layout">
      ...
      <div className="workbench-side-stack">
        <section className="data-card risk-card"><div><h3>当前健康风险概览</h3><strong>{summary?.active_fault_count ?? "—"}</strong><span>活动故障</span></div><p>统一健康分服务实时快照；风险计数来自正式告警汇总。</p></section>
        ...
        <section className="data-card today-card" aria-label="今日处置概览"><div className="panel-heading"><div><h3>今日处置概览</h3><p>截至当前更新时间</p></div><span className="status-chip status-chip--info">今日</span></div><div className="workbench-today-grid"><div><span>今日新增故障</span><strong className="prototype-unavailable">当前 API 未提供</strong></div><div><span>今日已处理</span><strong className="prototype-unavailable">当前 API 未提供</strong></div><div><span>平均处理时长</span><strong className="prototype-unavailable">当前 API 未提供</strong></div><div><span>平均响应时长</span><strong className="prototype-unavailable">当前 API 未提供</strong></div></div><div className="workbench-today-progress"><span>今日处理完成率</span><span className="progress-track" aria-hidden="true"><i style={{ width: "0%" }} /></span><b className="prototype-unavailable">当前 API 未提供</b></div></section>
